						...
						<div class="portlet-title">
								...
								<div class="actions">
										<a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('contact/create')}}"
												data-toggle="tooltip" title="{{trans('admin.add')}}  {{trans('admin.contact')}}">
												...
												<div class="modal-dialog">
														<div class="modal-content">
																...
																<div class="modal-body">
																		<i class="fa fa-exclamation-triangle"></i>   {{trans('admin.ask_del')}} {{trans('admin.id')}} ({{$contact->id}}) ؟
																</div>
...
{!! Form::open(['url'=>aurl('/contact/'.$contact->id),'method'=>'put','id'=>'contact','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="form-group">
    {!! Form::label('name',trans('admin.name'),['class'=>'col-md-3 control-label']) !!}
    <div class="col-md-9">
        {!! Form::text('name', $contact->name ,['class'=>'form-control','placeholder'=>trans('admin.name')]) !!}
    </div>
</div>
<br>
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::email('email', $contact->email ,['class'=>'form-control','placeholder'=>trans('admin.email')]) !!}
    </div>
</div>
<br>
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::textarea('message', $contact->message ,['class'=>'form-control','placeholder'=>trans('admin.message')]) !!}
    </div>
</div>
<br>
