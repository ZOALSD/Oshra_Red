              ...
              <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('conutry/create')}}"
                           data-toggle="tooltip" title="{{trans('admin.conutry')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                {{trans('admin.ask_del')}} {{trans('admin.id')}} {{$conutry->id}} ؟
...
<b>{{trans('admin.id')}} :</b> {{$conutry->id}}
</div>
<div class="clearfix"></div>
<hr />

<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.country_ar')}} :</b>
 {!! $conutry->country_ar !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.country_en')}} :</b>
 {!! $conutry->country_en !!}
</div>
