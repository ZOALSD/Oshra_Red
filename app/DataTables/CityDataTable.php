...
class CityDataTable extends DataTable
{
    ...
    {
        return City::query()->with(['conutry_id',])->select("cities.*");
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'conutry_id.country_ar',
                 'data'=>'conutry_id.country_ar',
                 'title'=>trans('admin.conutry_id'),
		    ],
				[
                 'name'=>'city_ar',
                 'data'=>'city_ar',
                 'title'=>trans('admin.city_ar'),
		    ],
				[
                 'name'=>'city_en',
                 'data'=>'city_en',
                 'title'=>trans('admin.city_en'),
		    ],
            [
	                'name' => 'actions',
	                'data' => 'actions',
