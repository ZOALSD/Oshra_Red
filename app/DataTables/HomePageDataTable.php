	...
	public function query()
    {
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'main_preghraph_ar',
                 'data'=>'main_preghraph_ar',
                 'title'=>trans('admin.main_preghraph_ar'),
		    ],
				[
                 'name'=>'main_preghraph_en',
                 'data'=>'main_preghraph_en',
                 'title'=>trans('admin.main_preghraph_en'),
		    ],
				[
                 'name'=>'sub_preghraph_ar',
                 'data'=>'sub_preghraph_ar',
                 'title'=>trans('admin.sub_preghraph_ar'),
		    ],
				[
                 'name'=>'sub_preghraph_en',
                 'data'=>'sub_preghraph_en',
                 'title'=>trans('admin.sub_preghraph_en'),
		    ],
				[
                 'name'=>'Where_we_work_ar',
                 'data'=>'Where_we_work_ar',
                 'title'=>trans('admin.Where_we_work_ar'),
		    ],
				[
                 'name'=>'Where_we_work_en',
                 'data'=>'Where_we_work_en',
                 'title'=>trans('admin.Where_we_work_en'),
		    ],
				[
                 'name'=>'about_say_ar',
                 'data'=>'about_say_ar',
                 'title'=>trans('admin.about_say_ar'),
		    ],
				[
                 'name'=>'about_say_en',
                 'data'=>'about_say_en',
                 'title'=>trans('admin.about_say_en'),
		    ],
				[
                 'name'=>'write_about_us_ar',
                 'data'=>'write_about_us_ar',
                 'title'=>trans('admin.write_about_us_ar'),
		    ],
				[
                 'name'=>'write_about_us_en',
                 'data'=>'write_about_us_en',
                 'title'=>trans('admin.write_about_us_en'),
		    ],
				[
                 'name'=>'Key_word',
                 'data'=>'Key_word',
				...
				[
                 'name'=>'Discraption_site',
                 'data'=>'Discraption_site',
                 'title'=>trans('admin.Discraption_site'),
		    ],
            [
	                'name' => 'actions',
	                'data' => 'actions',
