...
class BlogsBageDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.blogsbage.buttons.actions')
            ->addColumn('slide_image', 'admin.blogsbage.buttons.slide_image')
            ->addColumn('other_image', 'admin.blogsbage.buttons.other_image')
            ...
            ->rawColumns(['checkbox','actions','slide_image','other_image',]);
    }
    ...
    {
        return BlogsBage::query()->select("blogs_bages.*");
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'slide_image',
                 'data'=>'slide_image',
                 'title'=>trans('admin.slide_image'),
		    ],
				[
                 'name'=>'other_image',
                 'data'=>'other_image',
                 'title'=>trans('admin.other_image'),
		    ],
				[
                 'name'=>'youtube_link',
                 'data'=>'youtube_link',
