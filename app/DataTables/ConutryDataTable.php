...
class ConutryDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.conutry.buttons.actions')
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'country_ar',
                 'data'=>'country_ar',
                 'title'=>trans('admin.country_ar'),
		    ],
				[
                 'name'=>'country_en',
                 'data'=>'country_en',
                 'title'=>trans('admin.country_en'),
		    ],
            [
	                'name' => 'actions',
	                'data' => 'actions',
