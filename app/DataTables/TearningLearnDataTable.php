...
class TearningLearnDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.tearninglearn.buttons.actions')
            ->addColumn('main_image', 'admin.tearninglearn.buttons.main_image')
            ...
            ->rawColumns(['checkbox','actions','main_image',]);
    }
    ...
    {
        return Tearninglearn::query()->select("tearninglearns.*");
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'sup_p_ar',
                 'data'=>'sup_p_ar',
                 'title'=>trans('admin.sup_p_ar'),
		    ],
				[
                 'name'=>'sup_p_en',
                 'data'=>'sup_p_en',
                 'title'=>trans('admin.sup_p_en'),
		    ],
            [
	                'name' => 'actions',
	                'data' => 'actions',
