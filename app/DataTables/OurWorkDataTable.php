...
class OurWorkDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.ourwork.buttons.actions')
            ->addColumn('main_imig', 'admin.ourwork.buttons.main_imig')
            ->addColumn('what_our_do_img', 'admin.ourwork.buttons.what_our_do_img')
            ...
            ->rawColumns(['checkbox','actions','main_imig','what_our_do_img',]);
    }
    ...
    {
        return OurWork::query()->select("our_works.*");
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'main_imig',
                 'data'=>'main_imig',
                 'title'=>trans('admin.main_imig'),
		    ],
				[
                 'name'=>'main_p_ar',
                 'data'=>'main_p_ar',
                 'title'=>trans('admin.main_p_ar'),
		    ],
				[
                 'name'=>'main_p_en',
                 'data'=>'main_p_en',
                 'title'=>trans('admin.main_p_en'),
		    ],
				[
                 'name'=>'sub_p_ar',
                 'data'=>'sub_p_ar',
                 'title'=>trans('admin.sub_p_ar'),
		    ],
				[
                 'name'=>'sub_p_en',
                 'data'=>'sub_p_en',
                 'title'=>trans('admin.sub_p_en'),
		    ],
				[
                 'name'=>'what_our_do_ar',
                 'data'=>'what_our_do_ar',
                 'title'=>trans('admin.what_our_do_ar'),
		    ],
				[
                 'name'=>'what_our_do_en',
                 'data'=>'what_our_do_en',
                 'title'=>trans('admin.what_our_do_en'),
		    ],
				[
                 'name'=>'what_our_do_img',
                 'data'=>'what_our_do_img',
                 'title'=>trans('admin.what_our_do_img'),
		    ],
				[
                 'name'=>'why_oshra_unique_ar',
                 'data'=>'why_oshra_unique_ar',
                 'title'=>trans('admin.why_oshra_unique_ar'),
		    ],
				[
                 'name'=>'why_oshra_unique_en',
                 'data'=>'why_oshra_unique_en',
                 'title'=>trans('admin.why_oshra_unique_en'),
		    ],
				[
                 'name'=>'why_oshra_unique_img',
                 'data'=>'why_oshra_unique_img',
                 'title'=>trans('admin.why_oshra_unique_img'),
		    ],
				[
                 'name'=>'page_description',
                 'data'=>'page_description',
                 'title'=>trans('admin.page_description'),
		    ],
				[
                 'name'=>'key_Word',
                 'data'=>'key_Word',
                 'title'=>trans('admin.key_Word'),
		    ],
				[
                 'name'=>'p_color',
                 'data'=>'p_color',
